...
public final class LivePreviewActivity extends AppCompatActivity
  ...
  private static final long MAX_FACE_MISSING_PERIOD = 500; // Maxium permitted "Face missing" period in miliseconds
  private static final long MIN_FACE_FOUND_PERIOD = 3000; // milis "Face found!" period to start the "waving hello" execution
...
//                Toast.makeText(LivePreviewActivity.this, "I can see your face!!", Toast.LENGTH_SHORT).show();
                Log.d(TAG, "I can see your face!!");
              } else if(lastFaceLostTime != 0) {
                cancelLostFace();
//                Toast.makeText(LivePreviewActivity.this, "Never mind...", Toast.LENGTH_SHORT).show();
              }
            } else {
...
//                Toast.makeText(LivePreviewActivity.this, "Houston, we got problems.", Toast.LENGTH_SHORT).show();
              }
            }
          }
        });
  ...
  private Runnable foundFacePeriodFinishedChecker = new Runnable() {
    public void run() {
      ...
      if (System.currentTimeMillis() > lastFaceFoundTime + MIN_FACE_FOUND_PERIOD - 50) {
        seCancelaTodo();
//        Toast.makeText(LivePreviewActivity.this, "So... you still here...", Toast.LENGTH_SHORT).show();
        Log.d(TAG, "Activity!");
      }
    }
  };
...
//        Toast.makeText(LivePreviewActivity.this, "Please come back :'(", Toast.LENGTH_SHORT).show();
      }
    }
  };
